...
<a href="{{route('driver.create')}}" class="float-right btn btn-sm btn-primary">{{__('message.add_form_title',['form' => __('message.driver')])}}</a>
@endif
...
<script>
  ...
  $('#user-select').select2({
      width: '100%',
    ajax: {
      url: '/rewards/users/search?user_type=driver',
