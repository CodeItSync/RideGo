                    ...
                    <div class="card-body">
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    {{ Form::label('car_type',__('message.car_type').' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                                    {{ Form::select('userDetail[car_type]',[ 'normal' => __('message.normal') ,'premium' => __('message.premium') , 'vip' => 'Vip' ], old('userDetail[car_type]') ,[ 'class' =>'form-control select2js']) }}
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    {{ Form::label('account_iban',__('message.account_iban').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
                                    {{ Form::text('userBankAccount[account_iban]', old('userBankAccount[account_iban]'), ['class' => 'form-control', 'placeholder' => __('message.account_iban')]) }}
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    {{ Form::label('id_card_photo',__('message.id_card_photo'), ['class' => 'form-control-label']) }}
                                    <br/>
                                    <img style="width: 100%; max-height: 400px" src="/storage/{{$data->userDetail->id_card_photo ?? ''}}">
                                </div>

                                <div class="form-group col-md-12">
                                    {{ Form::label('driving_licence_photo',__('message.driving_licence_photo'), ['class' => 'form-control-label']) }}
                                    <br/>
                                    <img style="width: 100%; max-height: 400px" src="/storage/{{$data->userDetail->driving_licence_photo ?? ''}}">
                                </div>

                                <div class="form-group col-md-12">
                                    {{ Form::label('car_registration_photo',__('message.car_registration_photo'), ['class' => 'form-control-label']) }}
                                    <br/>
                                    <img style="width: 100%; max-height: 400px" src="/storage/{{$data->userDetail->car_registration_photo ?? ''}}">
                                </div>

                                <!--<div class="form-group col-md-12">-->
                                <!--    {{ Form::label('car_insurance_photo',__('message.car_insurance_photo'), ['class' => 'form-control-label']) }}-->
                                <!--    <br/>-->
                                <!--    <img style="width: 100%; max-height: 400px" src="/storage/{{$data->userDetail->car_insurance_photo ?? ''}}">-->
                                <!--</div>-->
                            </div>
                            <hr>
