                    ...
                    <div class="card-body">
                        <div class="new-user-info">
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('minimum_fee',__('message.per_kilo_min_fee').' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                                    {{ Form::number('minimum_fee', old('minimum_fee'),[ 'min' => 0, 'step' => 'any', 'placeholder' => __('message.per_kilo_min_fee'), 'class' => 'form-control' ]) }}
                                </div>

                                <div class="form-group col-md-4">
                                    {{ Form::label('maximum_fee',__('message.per_kilo_max_fee').' <span class="text-danger">*</span>',['class'=>'form-control-label'],false) }}
                                    {{ Form::number('maximum_fee', old('maximum_fee'),[ 'min' => 0, 'step' => 'any', 'placeholder' => __('message.per_kilo_max_fee'), 'class' => 'form-control' ]) }}
                                </div>
