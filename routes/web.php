...
Route::get('/set/driver/code', function () {
...
Route::group(['middleware' => ['auth', 'verified', 'admin']], function()
{
    ...
    Route::controller('App\Http\Controllers\RewardController')
        ->prefix('rewards')
        ->as('rewards.')
        ->group(function () {
    ...
    Route::post('withdrawrequest/admin_request', [ WithdrawRequestController::class, 'admin_request' ] )->name('withdraw.admin_request');
	...
	Route::post('users/notify-all', [ HomeController::class, 'notify_all'])->name('users.notify');
