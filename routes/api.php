...
use App\Http\Middleware\OnlyRidersAndActiveDriversCanPassMiddleware;
...
Route::post('complete-profile',[API\UserController::class,'completeProfile'])->middleware('auth:sanctum');
...
Route::get('companies-list',[API\CompanyController::class, 'list']);
