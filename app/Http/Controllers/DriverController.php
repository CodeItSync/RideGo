...
*/
    ...
    public function show(RideRequestDataTable $dataTable, $id)
    {
        ...
        $data = User::where('user_type', 'driver')
            ->with('roles','userDetail', 'userBankAccount')
            ->findOrFail($id);
        // dd($data->userDetail);
...
*/
    ...
    public function update(DriverRequest $request, $id)
    {
        ...
        $data = $request->except(['_method', '_token', 'userDetail', 'userBankAccount', 'dial_code']);
        // dd($data);
        // User user data...
